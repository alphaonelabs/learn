...
# Make src/ sub-packages (e.g. api/) importable during tests.
# The test runner's CWD is the project root, so src/ is not automatically
# on sys.path — worker.py's "from api.donations import …" would fail without this.
